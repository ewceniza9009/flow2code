...
// Import the LogoMap and DefaultLogo from TechLogos.tsx
...
const CustomNode = ({ id, data, selected }: NodeProps<NodeData>) => {
  ...
  // Get the logo component dynamically from LogoMap based on the tech stack
