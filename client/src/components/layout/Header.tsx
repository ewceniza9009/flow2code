import { ArrowLeft, Files, Play, Trash2, PanelLeft, PanelRight, Sun, Moon, Sparkles, ChevronDown, Search, Pencil, Settings, Lightbulb, Download, Upload, PlusIcon } from 'lucide-react';
...
                              ${activeProject.id === p.id
            ...
            <div className='flex items-center gap-2'>
              {/* <h1 className="text-lg font-bold text-primary dark:text-primary">flow2code</h1> */}
              {/* <button
            content='New Project'
            onClick={openNewProjectModal}
            className="w-full flex justify-start items-center gap-2 bg-background dark:bg-dark-background border border-border dark:border-dark-border rounded-md px-2 py-1 text-sm focus:ring-1 focus:ring-primary focus:outline-none"
            >
