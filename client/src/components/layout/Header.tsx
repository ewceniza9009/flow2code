...
    };
    
    // This is the function that now calls the API to generate code and populate the state
...
    // This button downloads a ZIP file from the generated code already in state
...
    // This function simply opens the editor if code has been generated
...
                                        className="flex items-center h-8 px-3 gap-2 text-text-main dark:text-dark-text-main font-bold border border-border dark:border-dark-border rounded-md cursor-pointer transition-colors hover:bg-border dark:hover:bg-dark-border"
                                    >
                                        {activeProject.name}
...
                            className={`flex items-center gap-1 pl-3 pr-2 py-1 text-sm font-semibold rounded-md transition-colors
                                        ${!generatedFiles ? 'bg-gray-500 text-white cursor-not-allowed' : 'bg-primary text-white hover:bg-primary-hover'}`}
                        >
                            <Code2 size={16} />
                            Show Code
                        </button>
...
                    className={`p-1 rounded-md hover:bg-border dark:hover:bg-dark-border transition-colors relative ${isSuggestionsPanelOpen ? 'bg-border dark:bg-dark-border' : ''}`}
...
                    )}
                </button>
                <button onClick={toggleLeftPanel} className="p-1 rounded-md hover:bg-border dark:hover:bg-dark-border transition-colors" title="Toggle Node Library"><PanelLeft size={18} /></button>
                <button onClick={toggleRightPanel} className="p-1 rounded-md hover:bg-border dark:hover:bg-dark-border transition-colors" title="Toggle Properties Panel"><PanelRight size={18} /></button>
